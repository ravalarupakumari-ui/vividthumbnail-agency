...
export default function App() {
  ...
  // Countdown timer logic for the alert popup
  React.useEffect(() => {
  ...
  const handleWhatsAppRedirect = () => {
    ...
    const text = `👋 Hello VividThumbnail Studio! I want to order a premium thumbnail.\n\n📝 VIDEO DETAILS:\n• Title: ${title}\n• Vibe/Style: ${vibe}\n\n? REMINDER: Sending my reference image right below this text!`;
    const encodedText = encodeURIComponent(text);
    window.open(`https://wa.me/${phoneNumber}?text=${encodedText}`, '_blank');
  };

  return (
    <div className="min-h-screen bg-[#090a0f] text-white font-sans flex flex-col items-center justify-center p-4">
      
      {/* ⚠️ HIGH-LEVEL CSS COUNTDOWN POPUP */}
      {!alertCleared && (
        <div className="fixed inset-0 bg-black/80 backdrop-blur-md flex items-center justify-center p-4 z-50 animate-fadeIn">
          <div className="bg-[#121420] border border-red-500/30 rounded-2xl p-6 max-w-md w-full shadow-2xl shadow-red-500/10">
            <h2 className="text-xl font-bold text-red-500 flex items-center gap-2 mb-4">
              ⚠️ CRITICAL ONBOARDING NOTICE
            </h2>
            <ul className="space-y-3 text-sm text-gray-300 mb-6">
              <li>• <strong className="text-white">Personalized Attention:</strong> This is an elite editing portal, NOT a robotic AI generator.</li>
              <li>• <strong className="text-white">Asset Hand-Off:</strong> Tapping submit wraps your text data and opens WhatsApp automatically.</li>
              <li>• <strong className="text-white">The Final Step:</strong> You must click send in WhatsApp and attach your reference image manually!</li>
            </ul>
            ...
            {countdown > 0 ? (
              ...
              <button 
                ...
                className="w-full bg-gradient-to-r from-emerald-500 to-teal-600 hover:from-emerald-400 hover:to-teal-500 text-white font-bold py-3 rounded-xl transition-all duration-300 transform hover:-translate-y-0.5 active:translate-y-0 shadow-lg shadow-emerald-500/20"
              >
        ...
        <div className="space-y-5">
          <div>
            ...
            <input 
              ...
              className="w-full bg-[#181b28] border border-gray-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-red-500/50 transition-colors"
            />
          </div>
          ...
          <div>
            ...
            <select 
              ...
              className="w-full bg-[#181b28] border border-gray-800 rounded-xl px-4 py-3 text-sm focus:outline-none focus:border-red-500/50 transition-colors appearance-none"
            >
          ...
          <div>
            ...
            <input 
              ...
              className="w-full text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-xl file:border-0 file:text-xs file:font-bold file:bg-gray-800 file:text-white hover:file:bg-gray-700 cursor-pointer"
            />
          </div>
          ...
          {title && image ? (
            <div className="pt-4 animate-fadeIn">
              ...
              <button 
                ...
                className="w-full bg-gradient-to-r from-emerald-500 to-teal-600 hover:scale-[1.02] text-white font-bold py-4 rounded-xl shadow-xl shadow-emerald-500/10 transition-all duration-300"
              >
